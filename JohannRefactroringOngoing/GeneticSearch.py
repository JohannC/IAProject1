...
class GeneticSearch:
    ...
    MAX_NUMBER_OF_SIBLINGS_COEFF = 20
    MIN_NUMBER_OF_SIBLINGS_COEFF = 10
    MAX_NUMBER_WITHOUT_IMPROVEMENT_COEFF = 3
    ...
    def _calculateParameters(self):
        numberOfDecade = self.cityMap.getNumberOfCities()/10
        minNumberOfSiblings = int(numberOfDecade*self.MIN_NUMBER_OF_SIBLINGS_COEFF)
        maxNumberOfSiblings = int(numberOfDecade*self.MAX_NUMBER_OF_SIBLINGS_COEFF)
        maxNumberWithoutImprovement = int(numberOfDecade*self.MAX_NUMBER_WITHOUT_IMPROVEMENT_COEFF)
        maxNumberOfMutation = int(numberOfDecade*self.MAX_NUMBER_OF_MUTATION_COEFF)
